...
public class PrimerParcial2021 {
		...
		final Actor ACTOR_1_ESPERADO = new Actor("Guillermo Franchella");
		...
		assertEquals(ANO_DE_ESTRENO_ESPERADO, pelicula.getAnioDeEstreno());
	...
	public void queSePuedaCrearUnVideojuego() {
		...
		assertEquals(CONSOLA_ESPERADA, juego.getTipoDeConsola());
